<?php
	function headhtml(){
		echo '<!DOCTYPE html>
			...
			<head>
			<title>Optrix Bidding Arena</title>
	  ...
	  <script type="text/javascript">
			...
			<div id="main_container">
			  ...
			  <div id="header">
				<div id="logo"> <a href="#"><img src="images/logo.png" alt="" border="0" width="237" height="120" /></a> </div>
	...
	function foothtml(){
		echo ' <div class="footer">
				<div class="left_footer"> <img src="images/footer_logo.png" alt="" width="150" height="60"/> </div>
				<div class="center_footer"> &copy; Optrix Bidding Arena.<br> All Rights Reserved. <br> 2018<br /> </div>
				<div class="right_footer"> Designed by Ankit/Sudo/Vaibhav. <br> Contact for Freelancing. <br> sudo_abhi@hotmail.com <br /></div>
			</div> 
