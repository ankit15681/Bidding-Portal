...
<body>
	<div id="container">
        ...
        <tbody>
        	<?php 
				$prodid = $_GET['id'];
				$query = mysqli_query($conn,"SELECT * FROM bidreport LEFT JOIN member ON member.memberid = bidreport.bidder LEFT JOIN products ON products.productid = bidreport.productid WHERE products.productid = '$prodid'") or die(mysqli_error());
