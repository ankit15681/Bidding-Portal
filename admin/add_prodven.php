...
//	$category=$_POST['category'];
    ...
    mysqli_query($conn,"INSERT INTO products(prodname,prodescription,startingbid,prodimage,regularprice,dateposted,duedate,status) 
						VALUES ('$prodname','$descrpt','$startingbid','$name','$regularprice',NOW(),'$duedate',0)") or die(mysqli_error());
...
<!--						<li class='showme'><a href="#"><img src="icons/36.png" alt />-->
                            <li class="current"><a href="add_prodven.php"><img src="icons/36.png"/><span>Products</span></a></li>
...
-->					
                        <li><a href="logout.php"><img src="./assets/icons/small_icons_3/settings.png"/><span>Log Out</span></a></li>
<!--
